...
@Component({
  ...
  styleUrl: './kids-shoes.component.css'
})
export class KidsShoesComponent {

  products: Product[] = [
    { id: 1, name: 'shoes 1', imageUrl: 'assets/images/kids/kids-shoes/kid-shoes-3.jpeg', price: 25, color: 'Black', size: 'M' ,description: 'A stylish kids shoes.'},
    { id: 2,name: 'shoes 2', imageUrl: 'assets/images/kids/kids-shoes/kid-shoes-5.jpeg', price: 90, color: 'Blue', size: 'L',description: 'A stylish kidss shoes.' },
    { id: 3,name: 'shoes 3', imageUrl: 'assets/images/kids/kids-shoes/kid-shoes-6.jpeg', price: 150, color: 'Pink', size: 'S',description: 'A stylish kidss shoes.' },
    { id: 4,name: 'shoes 4', imageUrl: 'assets/images/kids/kids-shoes/kid-shoes-7.jpeg', price: 50, color: 'Yellow', size: 'XL',description: 'A stylish kidss shoes.' },
