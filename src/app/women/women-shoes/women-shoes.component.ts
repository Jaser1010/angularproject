...
export class WomenShoesComponent {
  ...
  products: Product[] = [
    { id: 1, name: 'Shoes 1', imageUrl: 'assets/images/women/women-shoes/women-shoes-4.jpeg', price: 25, color: 'Black', size: 'M' ,description: 'A stylish women Shoes.'},
    { id: 2,name: 'Shoes 2', imageUrl: 'assets/images/women/women-shoes/women-shoes-5.jpeg', price: 90, color: 'Blue', size: 'L',description: 'A stylish women Shoes.' },
    { id: 3,name: 'Shoes 3', imageUrl: 'assets/images/women/women-shoes/women-shoes-6.jpeg', price: 150, color: 'Pink', size: 'S',description: 'A stylish women Shoes.' },
    { id: 4,name: 'Shoes 4', imageUrl: 'assets/images/women/women-shoes/women-shoes-7.jpeg', price: 50, color: 'Yellow', size: 'XL',description: 'A stylish women Shoes.' },
    { id: 5,name: 'Shoes 5', imageUrl: 'assets/images/women/women-shoes/women-shoes-8.jpeg', price: 200, color: 'Gray', size: 'M',description: 'A stylish women Shoes.' },
    { id: 6,name: 'Shoes 6', imageUrl: 'assets/images/women/women-shoes/women-shoes-9.jpeg', price: 85, color: 'Black', size: 'L' ,description: 'A stylish women Shoes.'},
